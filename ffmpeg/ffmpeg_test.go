...
func TestProbe(t *testing.T) {
	...
	pi, probeErr := Probe(context.Background(), Reader{Reader: dummy}, nil)
	if probeErr != nil {
		t.Error(probeErr)
	}
...
func TestReader(t *testing.T) {
	...
	pi, piErr := Probe(context.Background(), Reader{Reader: bytes.NewBuffer(output.Bytes())}, nil)
	if piErr != nil {
		t.Fatal(piErr)
	}
	// t.Logf("%+v", pi)
...
func TestWriterOutput(t *testing.T) {
	...
	piAudio, piErr := Probe(context.Background(), Reader{Reader: bytes.NewBuffer(outputAudio.Bytes())}, nil)
	if piErr != nil {
		t.Fatal(piErr)
	}
	...
	piVideo, piErr := Probe(context.Background(), Reader{Reader: bytes.NewBuffer(outputVideo.Bytes())}, nil)
	if piErr != nil {
		t.Fatal(piErr)
	}
